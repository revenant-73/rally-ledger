...
- Done: production tablet QA found the confirm-server roster grid clipped on 1024 x 768 landscape; added short-landscape density hooks and seven-column player grids for server, receiver, and involved-player selection. Needs production verification after deploy.
